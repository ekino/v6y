    ...
    'inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2',
    {
        variants: {
            variant: {
                ...
                success: 'border-transparent bg-green-400 text-white shadow-xs hover:bg-slate-200',
                warning: 'border-transparent bg-orange-400 text-white hover:bg-slate-300',
                error: 'border-transparent bg-red-500 text-white shadow-xs hover:bg-red-200',

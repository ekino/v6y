...
CREATE INDEX idx_audit_dimension_app_id ON audit_dimension(app_id);
CREATE INDEX idx_audit_dimension_app_metric_time ON audit_dimension(app_id, metric, created_at DESC);
CREATE INDEX idx_audit_dimension_source_id ON audit_dimension(source_id);
CREATE INDEX idx_audit_dimension_created_at ON audit_dimension(created_at DESC);

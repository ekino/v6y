const VitalityTerms = {
    ...
    VITALITY_EMPTY_DATA_MESSAGE: 'No data',

    VITALITY_GLOBAL_SEARCHBAR_INPUT_HELPER:
        'You can search by application name, package name or keyword (eslint, maintainability, ...)',
    VITALITY_SEARCHBAR_INPUT_PLACEHOLDER: 'Search pattern',
    VITALITY_SEARCHBAR_INPUT_LABEL: 'Search application',

    VITALITY_DASHBOARD_MENU_TITLE: 'Choose an option to view the relevant applications',
    VITALITY_DASHBOARD_PAGE_TITLE: 'Vitality: Keeping Your Codebase Healthy and High-Performing',

    VITALITY_APP_LIST_LOAD_MORE_LABEL: 'Click to load more applications',
    VITALITY_APP_LIST_OPEN_DETAILS_LABEL: 'See Details',
    ...
    VITALITY_APP_DETAILS_DEPENDENCIES_SELECT_PLACEHOLDER: 'All',
    ...
    VITALITY_APP_DETAILS_AUDIT_METRIC_TITLE: 'Metric',
    VITALITY_APP_DETAILS_AUDIT_METRIC_DESCRIPTION: 'Metric description',
    VITALITY_APP_DETAILS_AUDIT_METRIC_DESCRIPTION_EMPTY: 'No description identified',
    VITALITY_APP_DETAILS_AUDIT_METRIC_EXPLANATION: 'Issue explanation',
    VITALITY_APP_DETAILS_AUDIT_METRIC_EXPLANATION_EMPTY: 'No issue identified',
    VITALITY_APP_DETAILS_AUDIT_METRIC_BRANCH: 'Branch',
    VITALITY_APP_DETAILS_AUDIT_METRIC_MODULE: 'Module',
    VITALITY_APP_DETAILS_AUDIT_METRIC_SCORE: 'Score',
    VITALITY_APP_DETAILS_AUDIT_METRIC_STATUS: 'Status',
    VITALITY_APP_DETAILS_AUDIT_METRIC_STATUS_EMPTY: 'Default',
    VITALITY_APP_DETAILS_AUDIT_MORE_DETAILS: 'More Details',

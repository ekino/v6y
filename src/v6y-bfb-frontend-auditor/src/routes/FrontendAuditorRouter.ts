...
import FrontendDynamicStatusAuditorManager from '../auditors/FrontendDynamicStatusAuditorManager.ts';
import FrontendStaticStatusAuditorManager from '../auditors/FrontendStaticStatusAuditorManager.ts';

const { Router } = express;

const FrontendAuditorRouter: express.Router = Router();

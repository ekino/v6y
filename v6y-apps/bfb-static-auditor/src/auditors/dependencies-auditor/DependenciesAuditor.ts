import { AppLogger, ApplicationProvider, DependencyProvider } from '@v6y/core-logic';
...
const startAuditorAnalysis = async ({
    ...
    try {
        ...
        AppLogger.info(`[DependenciesAuditor - startAuditorAnalysis] auditRunId:  ${auditRunId}`);

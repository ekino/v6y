...
const VitalityGeneralInformationView = ({
    ...
    const { isLoading: isAppAuditReportsLoading, data: appAuditReports } = useClientQuery<{
    ...
    const indicators = (appAuditReports?.getApplicationDetailsAuditReportsByParams || []).map(
        (report) => ({
            ...
            <CardContent className="space-y-4">
                ...
                {isAppAuditReportsLoading ? (
                    ...
                    <p className="text-gray-700">
                        ⚠️ {translate('vitality.appDetailsPage.infos.noIndicators')}
                    </p>
                )}
            </CardContent>
        </Card>
